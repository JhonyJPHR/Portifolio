...
export function HeroSection() {
  return (
    <motion.section variants={itemVariants} className="text-center pt-20">
      ...
      >
        Transformo dados brutos em insights estratégicos e construo aplicações
        inteligentes para resolver problemas complexos.
      </motion.p>
      <motion.div
      ...
      >
        <Button variant="outline" size="icon" asChild>
          <a
            href="https://github.com/JhonyJPHR"
            target="_blank"
        ...
        <Button variant="outline" size="icon" asChild>
          <a
            href="https://www.linkedin.com/in/jhony-wesley-02b6a8288/"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="LinkedIn"
          >
        ...
        <Button variant="outline" size="icon" asChild>
          <a href="mailto:wesleyjhony933@gmail.com" aria-label="Email">
            <Mail />
          </a>
        </Button>
      </motion.div>
